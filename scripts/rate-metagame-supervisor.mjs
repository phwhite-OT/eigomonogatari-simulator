...
const batchStatusPath = path.resolve(projectRoot, readArgument("batch-status", "reports/metagame-v6-batch-status.json"));
const supervisorStatusPath = path.resolve(projectRoot, readArgument("status", "reports/metagame-v6-supervisor-status.json"));
const activePath = path.resolve(projectRoot, readArgument("active", "reports/metagame-v6-active.json"));
