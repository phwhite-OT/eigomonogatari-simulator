...
const batchStatusPath = path.resolve(projectRoot, readArgument("batch-status", "reports/metagame-v5-batch-status.json"));
const supervisorStatusPath = path.resolve(projectRoot, readArgument("status", "reports/metagame-v5-supervisor-status.json"));
const activePath = path.resolve(projectRoot, readArgument("active", "reports/metagame-v5-active.json"));
