...
import { METAGAME_V12_MODEL_VERSION } from "../src/core/metagame-v12.js";
...
const progress = savedProgress?.context?.version === METAGAME_V12_MODEL_VERSION ? savedProgress : null;
